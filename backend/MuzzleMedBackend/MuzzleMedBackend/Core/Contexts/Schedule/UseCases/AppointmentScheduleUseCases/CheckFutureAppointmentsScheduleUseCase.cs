...
public class CheckFutureAppointmentsScheduleUseCase : ICheckFutureAppointmentsScheduleUseCase
{
    private readonly IAppointmentRepository _repository;

    public CheckFutureAppointmentsScheduleUseCase(IAppointmentRepository repository)
    {

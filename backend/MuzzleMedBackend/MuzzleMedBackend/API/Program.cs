...
// Configs do Banco de dados (MySQL)
...
builder.Services.AddScoped<IBookTimeRepository, BookTimeRepository>();
builder.Services.AddScoped<BookTimeUseCase>();
...
app.MapControllers().RequireCors("PermitirFrontend");
